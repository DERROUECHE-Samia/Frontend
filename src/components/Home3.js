...
/**
 * Composant représentant la troisième section de la page d'accueil avec une image en défilement.
 *
 * @component
 * @returns {JSX.Element} Composant React représentant la troisième section.
 */
